								...
								<div class="card-body">
									<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-7">
												<input type="text" class="form-control" name="StuStudentName" placeholder="Enter Name" required>
											</div>
								...
								<div class="col-sm-10">
                                      ...
                                      <input type="radio" value="Female" name="StuGender" style="margin-left:5px; ">Female
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-4">
												<input type="number" class="form-control" name="StuParentMobileNumber1" placeholder="primary No" required>
											</div>
											<div class="col-sm-4">
												<input type="number" class="form-control" name="StuParentMobileNumber2" placeholder="Secondary No">
											</div>
										</div>
										<div class="mb-3 row">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-4">
												<input type="number" class="form-control" name="StuAadharNo" placeholder="" required>
											</div>
										</div>
										<div class="mb-3 row">
