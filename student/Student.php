									...
									<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" onsubmit="return validation()">
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-2">
												...
												name="StuStudentName"  placeholder="FirstName"  required>
											</div>
											<div class="col-sm-2">
												<input type="text" class="form-control"
												name="Stumiddle"  placeholder="MiddelName" required>
											</div>
											<div class="col-sm-2">
												<input type="text" class="form-control"
												name="StuLastname" placeholder="LastName" required>
											</div>
								...
								<div class="col-sm-10">
                                      ...
                                      <input type="radio" value="Female" name="StuGender" style="margin-left:5px; ">Female
										...
										<div class="mb-3 row">
											...
											<div class="col-sm-4">
												<input type="number" class="form-control" name="StuParentMobileNumber1" placeholder="primary No" 
