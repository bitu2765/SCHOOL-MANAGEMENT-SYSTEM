                                            ...
                                            <div class="container text-left" style="margin-left: 30px;">
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        ...
                                                        <input type="text" name="exam_std" id="" required=""
                                                            class="form-control"
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        ...
                                                        <input type="text" id="" class="form-control" name="exam_name"
                                                            value="<?php echo $row ['ExamName'];?>">
                                                        <?php }}?>
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        <?php  $m4="SELECT ExamSubjectName FROM `exammaster`where Examid = '".$_GET["id"]."'";
                                                                ...
                                                                if ($result3->num_rows > 0) {
                                                                    while($row = $result3->fetch_assoc()){ ?>
                                                        <input type="text" id="" class="form-control" name="exam_sub"
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        <?php  $m4="SELECT ExamTotalMarks FROM `exammaster`where Examid = '".$_GET["id"]."'";
                                                                ...
                                                                if ($result3->num_rows > 0) {
                                                                    while($row = $result3->fetch_assoc()){ ?>
                                                        <input type="text" id="" class="form-control" name="exam_tm"
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        <?php  $m4="SELECT ExamPassingMarks FROM `exammaster`where Examid = '".$_GET["id"]."'";
                                                                ...
                                                                if ($result3->num_rows > 0) {
                                                                    while($row = $result3->fetch_assoc()){ ?>
                                                        <input type="text" id="" class="form-control" name="exam_pm"
