                                        ...
                                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                                            <div class="container text-left" style="margin-left: 30px;">
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        <input type="text" required="" name="add_name"
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-7">
                                                        <select name="add_type" id="Examtype" required=""
                                                            class="form-control">
                                                ...
                                                <div class="row" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-3">
                                                        <input type="button" name="sub_Search" class="btn btn-success"
                                                            value="SEARCH" onclick="fetchExam()">
