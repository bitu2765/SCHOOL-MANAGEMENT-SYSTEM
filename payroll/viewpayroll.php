                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        ...
                        <ul id="payr" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link" href="addpayroll.php">Add Pay</a></li>
                            <li class="sidebar-item active"><a class="sidebar-link" href="viewpayroll.php">View Pay</a></li>
                ...
                <div class="container-fluid p-0">
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-none d-sm-block">
                            <h3><strong>View</strong>Payroll</h3>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 text-left">
                                            <button type="button" class="btn btn-success" id="gendata">View</button>
                                        </div>
                                    </div>
                                </div>
