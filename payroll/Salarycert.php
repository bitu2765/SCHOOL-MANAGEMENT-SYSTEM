                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        ...
                        <ul id="payr" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                            ...
                            <li class="sidebar-item active"><a class="sidebar-link" href="Salarycert.php">Salary Certificate</a></li>
                                ...
                                <div class="container">
                                    <form action="salcertgen.php" method="get">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 text-center">
                                                <button type="submit" class="btn btn-lg btn-pill btn-success">SAVE</button>
                                            </div>
                                            <!-- <div class="col-md-4 text-center">
