                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item  active">
                        ...
                        <ul id="pstu" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                            ...
                            <li class="sidebar-item active"><a class="sidebar-link" href="../ProStu/StudentPromote.php">Promote Student</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-header">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 font-weight-bold">
                                            Current Acedemic Year :
                                        </div>
                                        <div class="col-md-3">
                                            <select class="form-control" id="mose" placeholder="ei">
                                                <option value="0">Select Acedemic Year</option>
                                                <?php
                                                include("aayear.php");
                                                ?>
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" id="pstd" placeholder="ei">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" id="nay" placeholder="ei">
                                                <option value="0">Select Acedemic Year</option>
                                                <?php
                                                include("naayear.php");
                                                ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input class="form-control" type="text" name="nsem" id="nsem" placeholder="Next Standard" readonly>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <button type="button" id="pds" class="btn btn-success">Promote Student</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
